...
4. Подтвердите установку и дождитесь 100%. Не отключайте кабель во время
   прошивки.
5. При первой установке разрешите очистку устройства, если установщик спросит.
   При последующем обновлении оставьте очистку выключенной, чтобы сохранить
   настройки.
...
питание и дождитесь `MAP CACHE ... 4/4`: после этого радар откроется сам.
