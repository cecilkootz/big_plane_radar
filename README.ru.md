...
аэропортов и ВПП, режим символов, состав подписей самолётов, яркость и
опциональная подложка. Селектор символов показывает оба варианта прямо на
странице. Выберите `None` для обычного радара без карты либо `Stadia Alidade
